...
class Config:
    ...
    DEFAULT_RETRY_DELAY: float = float(os.getenv("SPACK_INSTALLER_RETRY_DELAY", "7200.0"))  # seconds
    RETRY_CHECK_INTERVAL: float = float(os.getenv("SPACK_INSTALLER_RETRY_CHECK_INTERVAL", "7200.0"))  # 5 minutes
